package cn.epicfx.winfxk.byenchant.iosdialog;
...
public class Toast {
	...
	public static final int[] Images = { R.drawable.toast_icon1, R.drawable.toast_icon2, R.drawable.toast_icon3,
			R.drawable.toast_icon4 };
	 ...
	 * @return
	 */
	public static Toast makeText(Context context, String string, int i) {
		Toast tsate = new Toast(context);
		tsate.setText(string);
		tsate.setTime(i);
		tsate.setRandImage();
		return tsate;
	}
	 ...
	 * @return
	 */
	public static Toast makeText(Context context, String string) {
		return makeText(context, string, LENGTH_SHORT);
	}
